...
export const getOnlishopVersion = createSender('contextOnlishopVersion', {});
export const compareIsOnlishopVersion = getCompareIsOnlishopVersion(getOnlishopVersion);
...
/**
 * Get the current Onlishop version
 */
export type contextOnlishopVersion = {
  responseType: string,
}
