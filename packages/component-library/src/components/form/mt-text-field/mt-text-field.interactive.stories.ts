...
export const TestInputValue: MtTextFieldStory = {
  ...
  play: async ({ canvasElement, args }) => {
    ...
    await userEvent.type(canvas.getByRole("textbox"), "Onlishop");
    await userEvent.click(canvas.getByText("hidden"));

    expect((canvas.getByRole("textbox") as HTMLInputElement).value).toBe("Onlishop");

    expect(args.change).toHaveBeenCalledWith("Onlishop");
  },
};
...
export const VisualTestCharacterCountExceeding: MtTextFieldStory = {
  ...
  play: async ({ canvasElement, args }) => {
    ...
    await userEvent.type(
      ...
      "Onlishop is a trendsetting ecommerce platform to power your online business.",
    );
    await userEvent.click(canvas.getByText("hidden"));
    ...
    expect(args.updateModelValue).toHaveBeenCalledWith(
      "Onlishop is a trendsetting ecommerce platform to power your ",
    );
