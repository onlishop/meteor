...
export const SetLink: MtTextEditorStory = defineStory({
  ...
  play: async ({ canvasElement, args }) => {
    ...
    await userEvent.type(linkInput, "https://www.onlishop.com");
    ...
    // Check if args was triggered with new content
    expect(args.updateModelValue).toHaveBeenCalledWith(
      '<h1><a target="_blank" rel="noopener noreferrer nofollow" href="https://www.onlishop.com">Hello World</a></h1><p>Some text</p>',
    );
  },
});
 ...
 * - https://github.com/onlishop/onlishop/discussions/11570
 * - https://github.com/onlishop/onlishop/issues/11216
 *
