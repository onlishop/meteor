...
watch(
  ...
  () => {
    import(
      `./../../../../node_modules/@onlishop/meteor-icon-kit/icons/${iconInformation.value.mode}/${iconInformation.value.name}.svg`
    )
      .then((data) => {
        if (data.default) {
...
<style lang="scss">
@import "node_modules/@onlishop/meteor-icon-kit/icons/meteor-icon-kit.scss";
