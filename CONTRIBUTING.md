...
Onlishop is available under [MIT license](./LICENSE.md).
...
Please take a look at the [existing issues](https://github.com/onlishop/meteor/issues)
...
Search trough the [list of existing feature requests](https://github.com/onlishop/meteor/issues),
...
you can [request a feature](https://github.com/onlishop/meteor/issues/new).
...
3. Link package in the Onlishop Administration folder with `yalc link <package-name@package-version>`
...
2. Go to the [actions tab](https://github.com/onlishop/meteor/actions)
3. Click on [Visual Tests](https://github.com/onlishop/meteor/actions) in the left sidebar
