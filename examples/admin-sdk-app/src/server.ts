...
import { App } from "@onlishop/app-server-sdk";
import { Config } from '@onlishop/app-server-sdk/config';
import { InMemoryShopRepository } from '@onlishop/app-server-sdk/repository';
import { NodeHmacSigner } from '@onlishop/app-server-sdk/runtime/node/signer';
import { convertRequest, convertResponse, rawRequestMiddleware } from '@onlishop/app-server-sdk/runtime/node/express';
...
async function createServer() {
    ...
    const vite = await createViteServer({
        ...
        optimizeDeps: {
            include: [
                '@onlishop/meteor-admin-sdk',
                '@onlishop/meteor-component-library'
            ]
        },
    })
