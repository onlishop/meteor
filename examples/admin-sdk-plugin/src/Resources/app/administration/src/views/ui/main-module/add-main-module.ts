...
import { notification, context, data, window } from '@onlishop/meteor-admin-sdk';
import { SwButton, SwTextField, SwTextarea } from '@onlishop/meteor-component-library';
...
export default defineComponent({
    ...
    template: `
        <div style="padding: 20px;">
            ...
            <div>
                <h3>Context - Get current Onlishop version</h3>
                <sw-button @click="getOnlishopVersion">Get current Onlishop version</sw-button>

                <p>
                    Onlishop version: {{ onlishopVersion }}
                </p>
            </div>
            ...
            routeInformation:  `
{
    ...
    methods: {
        ...
        // context / get current Onlishop version
        async getOnlishopVersion() {
            this.onlishopVersion = await context.getOnlishopVersion();
        },
