...
The Meteor Admin SDK is an NPM library for Onlishop 6 apps and plugins that need an easy way of extending or customizing the Administration.
...
Understand the Onlishop Extension SDK by learning how to throw a notification.

Requirements for this quick start guide are:
- [Onlishop 6 self-hosted instance](https://developer.onlishop.com/docs/guides/installation) or a [Onlishop 6 cloud instance](https://www.onlishop.com/en/onlishop-cloud/)
- [clean Onlishop 6 Plugin or App](https://developer.onlishop.com/docs/guides/plugins/overview) which is activated
...
2. Add the link to the webpage and to the [manifest.xml](https://developer.onlishop.com/docs/guides/plugins/apps/app-base-guide#manifest-file) of your app. For local files you can use [ngrok](https://ngrok.com/) to create a public URL for your HTML file.
...
### Plugin
**Notice:** Plugins will only be working on self-hosted instances. You can't use a Onlishop 6 cloud instance for plugins.
...
2. Start the Onlishop 6 Administration watcher using the following command: 
```bash
