...
Onlishop 6 has a rich plugin extension system for the Admin based on Twig and the concepts of component overriding and component extending. These
...
Onlishop.Component.override('sw-dashboard-index', {
    methods: {
...
**This feature is not yet released in Onlishop.
It's only available with the development enviroment or `dev-trunk` version of Onlishop.**

It is useful when you want to migrate partially from the twig plugin system to the SDK extension system that you use both systems together. To make this happen you can render normal Vue components in the Onlishop administration for the locations instead of your iFrame view.
