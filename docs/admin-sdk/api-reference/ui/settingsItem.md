...
### Add settings item
Add a new settings item to the Onlishop settings. The content of the settings item module is determined by your `locationId`. 
...
In case that doesn't work take a look at the list [here](https://github.com/onlishop/meteor-admin-sdk/blob/trunk/src/icons.ts).
